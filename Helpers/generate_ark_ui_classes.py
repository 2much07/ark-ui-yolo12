"""
ARK UI class definitions generator.
This script generates an updated version of ark_ui_classes.py with class names from class.txt.
"""
...
def generate_python_file(classes, output_path):
    """Generate the Python file with the updated classes."""
    header = '''"""
...
if __name__ == "__main__":
    ...
    output_file = "ark_ui_classes_updated.py"
